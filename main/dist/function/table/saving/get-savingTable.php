...
foreach ($result as $row) {
    ...
    if ($row['comment'] != null) {
        ...
        $sub_array[] = '<span class="badge badge-danger">No comment</span>';
    }
    $sub_array[] = $row['time'];
    $sub_array[] = '<button type="button" name="view-bank" id="' . $row['bankID'] . '" class="btn btn-primary btn-sm view-bank""><i class="fas fa-eye"></i> Bank Details</button>';
